                                ...
                                {entrada.map((item, i) => (
                                    <tr key={item.nombre}>
                                        ...
                                        <td>
                                            ...
                                            <button className="btn btn-danger" onClick={() => deleteEmpleado(item.id)}>
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <Campo
                                idCampo='dni'
                                iconName='fa-solid fa-id-card-clip'
                                placeholderName="Ingrese el DNI"
                                tipoCampo="text"
                                value={dni}
                            ...
                            <Campo
                                idCampo='direccion'
                                iconName='fa-solid fa-route'
                                placeholderName="Ingrese el direccion"
                                tipoCampo="text"
                                value={direccion}
                            ...
                            <Campo
                                ...
                                placeholderName="Ingrese el correo"
                                tipoCampo="text"
                                value={email}
